...
public class TakeExperienceCMD {

    public TakeExperienceCMD(OPPrison plugin) {
        ...
        Commands.create()
                ...
                .handler(c -> {
                    ...
                    playerStorage.get(target.getUniqueId()).ifPresent(pp -> pp.takeExperience(amount));
                                    ...
                                    .hoverEvent(HoverEvent.showText(
                                            TextComponent.of(
                                                    StringUtils.color("&7Below is information on how your &cExperience Data" + "\n" +
                                                            "&7has been altered: " + "\n" +
                                                            "" + "\n" +
                                                            "&c&l" + Lang.BLOCK_SYMBOL.getMessage() + "&fExperience Removed: " + Number.pretty(amount)
                                                    ))
                                    ))
                    );
